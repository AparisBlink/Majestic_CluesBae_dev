	...
	Majestic_CluesBae_devStyle.prototype = {
		...
		ckEditorStyles: {
			...
			styles: [
				...
				{ name: 'Título 06', element: 'h4', attributes: { 'class': 'bck-title-6'} },
				{ name: 'Título 07', element: 'h4', attributes: { 'class': 'bck-title-7'} },
				{ name: 'Título 08', element: 'h4', attributes: { 'class': 'bck-title-8'} },
				{ name: 'Título 09', element: 'h4', attributes: { 'class': 'bck-title-9'} },
