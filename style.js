	...
	Majestic_CluesBae_devStyle.prototype = {
		...
		ckEditorStyles: {
			...
			styles: [
				...
				{ name: 'Lista desordenada 06', element: 'ol', attributes: { 'class': 'bck-ul bck-ul-6' } },
				{ name: 'Lista desordenada 07', element: 'ol', attributes: { 'class': 'bck-ul bck-ul-7' } },
				{ name: 'Lista desordenada 08', element: 'ol', attributes: { 'class': 'bck-ul bck-ul-8' } },
				{ name: 'Lista desordenada 09', element: 'ol', attributes: { 'class': 'bck-ul bck-ul-9' } },
				{ name: 'Lista desordenada 10', element: 'ol', attributes: { 'class': 'bck-ul bck-ul-10' } },
